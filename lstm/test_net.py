...
if __name__ == '__main__':
    ...
    imgdb = edict({'path':'/media/nas/ocr/OCR_samples/tfrecord/200+22_mix/train.tfrecords','name':'lstm_'+output_network_name,
                   'val_path':'/media/nas/ocr/OCR_samples/tfrecord/200+22_mix/val.tfrecords' })
    ...
    test_net(network, imgdb,
              testDir= '/media/nas/ocr/lstm_ctc_ocr_beta/lib/utils/data/test/', #'data/demo'
