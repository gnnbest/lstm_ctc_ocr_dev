...
import sys
sys.path.append("../../../")
from lib.lstm.get_txt import get_key
...
#__C.CHARSET = '远田她他平试分推野教把面竖于荐女娲的里一图向宽忧优阅娲补天到们切行文厘患读造天塌下震地裂沟岗深烧着大熊火藏日子点周计算测红等姹紫嫣红苦鲜颜懂许扎知识造人周长御寒遮丑嫦娥刚吴实验版长懂得号测英苦奔月生于想含子出现道好黑嘿五六色符想御藏慌皇荒图形厘米中括'
__C.CHARSET = get_key("/media/nas/ocr/lstm_ctc_ocr_beta/lib/utils/data/stpics/generate_samples_gnn/2-8_words")
